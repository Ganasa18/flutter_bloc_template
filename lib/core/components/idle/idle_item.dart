...
import 'package:my_template/core/components/button/primary_button.dart';
...
class IdleNoItemCenter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: AppSetting.deviceWidth,
      height: useDeviceHeight ? AppSetting.deviceHeight / 2 : null,
      child: iconPath == null
          ? (useCenterText == true
              ? Center(
                  child: Column(
          ...
          : Column(
              ...
              children: <Widget>[
                Image.asset(iconPath ?? "",
                    width: double.infinity, height: AppSetting.setHeight(350)),
                Text(title ?? " ",
                    textAlign: TextAlign.center,
                    style: MyTheme.style.subtitle.copyWith(
                        color: color ?? context.blackWhiteColor,
