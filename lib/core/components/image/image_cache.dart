import 'package:my_template/core/components/loading/loading_singlebox.dart';
...
CachedNetworkImageProvider baseImageDecorationComponent({
  required String url,
    ...
    CachedNetworkImageProvider(
      url.isNotEmpty
          ? url
          : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxeAS3OYy1yQBs03eiKx1FBjuEVW-Hcy28AVvbyAOzSmrV5-kHMBQakzM8hKMsc7NN0Qo&usqp=CAU",
    );
