...
import 'package:my_template/core/models/base_response.dart';
import 'package:my_template/core/models/base_response_list.dart';
import 'package:my_template/core/networks/api_client.dart';
import 'package:my_template/core/networks/error_handler.dart';
import 'package:my_template/core/networks/result_handler.dart';
...
class ApiDataSource<T> {
  ...
  Future<Either<Failure, T>> get(String endpoint,
  ...
  Future<Either<Failure, List<T>>> getList(String endpoint,
  ...
  Future<Either<Failure, T>> post(String endpoint, Map<String, dynamic> data,
  ...
  Future<Either<Failure, T>> put(String endpoint, Map<String, dynamic> data,
      {bool formData = false}) async {
    try {
